        ...
        <div className="min-h-screen relative p-6">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <div className="mb-6">
                    {!isAdminMode ? (
                        <div className="flex justify-between items-center">
                            <Button onClick={loadData} variant="ghost" size="sm" className="text-white hover:text-white/80" disabled={isLoading}>
                                <RefreshCw className={`h-4 w-4 mr-1 ${isLoading ? "animate-spin" : ""}`} />
                                Atualizar
                            </Button>
                            {!showAdminLogin ? (
                                <Button onClick={() => setShowAdminLogin(true)} variant="ghost" size="sm" className="text-white hover:text-white/80">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-3xl font-light text-white hover:text-white/80 mb-2">Votação de Jogos</h1>
                    <p className="text-white hover:text-white/80">Escolha qual jogo deve ser jogado na próxima stream</p>
                    ...
                    <div className="mt-3 text-xs text-white hover:text-white/80">
                ...
                <footer className="mt-16 border-t border-gray-200 pt-8">
                    <div className="text-center space-y-4">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-lg text-white hover:text-white/80">Arthur Araújo</h3>
                            <p className="text-white hover:text-white/80">Desenvolvedor Full Stack & Streamer</p>
                        </div>
                        ...
                        <div className="flex justify-center items-center gap-6">
                            <a
                                ...
                                className="flex items-center gap-2 text-white hover:text-white/80 hover:text-gray-900 transition-colors"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 text-white hover:text-white/80 hover:text-purple-600 transition-colors"
                            >
                                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 text-white hover:text-white/80 hover:text-blue-600 transition-colors"
                            >
                                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a
                                ...
                                className="flex items-center gap-2 text-white hover:text-white/80 hover:text-red-600 transition-colors"
                            >
                        ...
                        <div className="text-sm text-white hover:text-white/80 space-y-1">
                        ...
                        <div className="flex justify-center items-center gap-2 pt-2 ">
                            <Badge variant="outline" className="text-xs text-white hover:text-white/80">
                                Next.js
                            </Badge>
                            <Badge variant="outline" className="text-xs text-white hover:text-white/80">
                                React
                            ...
                            <Badge variant="outline" className="text-x text-white hover:text-white/80">
                                TypeScript
                            </Badge>
                        </div>
                    </div>
